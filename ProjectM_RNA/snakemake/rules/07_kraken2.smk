rule kraken2:
    ...
    output:
        kraken2_output = f"{OUTPUT_DIR}/07_kraken2/{{sample}}.kraken",
        kraken2_report = f"{OUTPUT_DIR}/07_kraken2/{{sample}}.report",
        kraken2_log = f"{OUTPUT_DIR}/07_kraken2/kraken2_{{sample}}.log"
    threads: 
        thread_kraken2
    shell:
        """
        ...
        --paired {input.rRNA_removed_fastq1} {input.rRNA_removed_fastq2} \
        --use-names \
