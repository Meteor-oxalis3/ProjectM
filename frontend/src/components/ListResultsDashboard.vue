    ...
    <v-row justify="center" align="center">
      <v-col cols="12">
        <v-card>
          ...
          <v-data-table hide-default-footer v-model="selectedFolders" :headers="headers" :items="folders"
            :loading="isLoading" item-value="name" :sort-by="sortBy" show-select :items-per-page="5" dense
